...
// +kubebuilder:resource:scope=Namespaced,shortName=contentsourcebinding
// +kubebuilder:printcolumn:name="ContentSource",type="string",JSONPath=".contentSourceRef.name"

// ContentSourceBinding is a binding object responsible for
// defining a ContentSource and a Namespace associated with it
type ContentSourceBinding struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	// ContentSourceRef is a reference to a ContentSource object
	ContentSourceRef ContentSourceReference `json:"classRef,omitempty"`
}
